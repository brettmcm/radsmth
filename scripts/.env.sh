...
REMOTE_SSH_LOGIN="deploy@s.stance.com"
REMOTE_SSH_PORT="22"
...
REMOTE_ROOT_PATH="/var/www/uncommon/"
REMOTE_ASSETS_PATH=${REMOTE_ROOT_PATH}"web/images"

# Remote database constants; default port for mysql is 3306, default port for postgres is 5432
REMOTE_DB_NAME="db_stance_prod"
REMOTE_DB_PASSWORD="5t@nc34Craft"
REMOTE_DB_USER="root"
